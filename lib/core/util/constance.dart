...
abstract class UrlBuilder {
  static const String BASE_URL = "https://gssapi.scibd.info/api";
...
class Api {
  static String userLogin() => UrlBuilder.buildUrl(endPoint: "/Login");
  ...
  static String getDetailUrl(int movieId) => UrlBuilder.buildUrl(endPoint: "/$movieId");


  static String getCreditsUrl(int movieId) => UrlBuilder.buildAdvancedUrl(movieId: "/$movieId", endPoint: "/credits");

  static String getRecommendationUrl(int movieId) => UrlBuilder.buildAdvancedUrl(movieId: "/$movieId", endPoint: "/recommendations");
